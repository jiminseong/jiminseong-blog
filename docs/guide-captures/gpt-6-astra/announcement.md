...
페이지 제목: GPT-6 Astra: A new generation of intelligence | OpenAI
페이지에 적힌 날짜: September 3, 2026 (페이지 메타데이터 publicationDateText)
수집 시각: 2026-09-13 (Asia/Seoul)
비고: 한국어(ko-KR) 자동 리다이렉트본은 일부 문단이 미번역 영어로 섞여 있어 인용 정확도를 위해 en-US 원문을 저장
-->
