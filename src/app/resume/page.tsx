      ...
      <Container>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <Section title="프로젝트">
            ...
            >
              <li>
                AIM이라는 슈퍼앱 가설로 시작해 개밥먹기로 반증(누적 다운로드 <b>4</b>)을
                발견하고, 모노레포 기반 <b>2개</b> 앱으로 분리하는 피벗을 거쳐 LOG 출시.
                마케팅 비용 <b>0원</b>, 출시 <b>89일</b>에 App Store 누적 다운로드{" "}
                <b>1,313</b>, 30일 활성 사용자 <b>894명</b>, 기록된 운동 세트 <b>6.6만</b>.
              </li>
              <li>
                유입이 전부 스토어 검색인 것을 확인하고 로케일별 키워드를 넓혀 사용자{" "}
                <b>90%</b>가 해외다(중국어 <b>76%</b>). <b>92개</b> 운동 카탈로그,{" "}
                <b>10개</b> 언어 지원. 현재 <b>1.7.0</b>, 양대 스토어 운영 중.
              </li>
              <li>
                운동 <b>5일</b>을 채운 사용자에게 PMF 설문을 띄워 유료화 가능성을 먼저 검증.
                응답 <b>83명</b> 중 <b>57%</b>가 &ldquo;없어지면 많이 아쉽다&rdquo;를 골랐다.
              </li>
              <li>
