...
> **직접 클릭하기 귀찮으신가요?**
> 이 과정을 Aside 브라우저를 이용해서 A부터 Z까지 하나의 프롬프트로 완료하는 방법은 아래 링크를 참고해요.
> 👉 [Aside 브라우저로 도메인 연결 한 번에 끝내기](/guide/aside-browser-domain-setup-2026)
> 맥을 쓰신다면 이쪽이 훨씬 빠릅니다. 윈도우라면 아래 방법대로 따라오세요.
...
맥을 쓰신다면 [Aside로 한 번에 끝내는 방법](/guide/aside-browser-domain-setup-2026)도 함께 읽어 보세요.
