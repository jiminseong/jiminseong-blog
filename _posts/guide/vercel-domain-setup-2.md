...
coverImage: "/assets/blog/guide/vercel-domain-setup-2/cover.png"
date: "2026-09-13"
ogImage:
  url: "/assets/blog/guide/vercel-domain-setup-2/cover.png"
category: guide
aiAssisted: true
---

[1편](/guide/vercel-domain-setup)에서 가비아에서 도메인을 샀어요. 이번 편은 그 도메인을 Vercel 사이트에 붙입니다.

- 가비아가 아닌 곳에서 샀어도 괜찮아요. 글 끝에 설명이 있어요.
- 값 한 줄을 복사해 붙여넣는 게 전부예요. 10분이면 끝나고, 반영까지 길어야 하루예요.
- 도메인이 뭔지, IP 주소가 뭔지는 [1편의 용어 설명](/guide/vercel-domain-setup)에 있어요.

이 글의 주소는 `jiminseong.com/guide/vercel-domain-setup-2` 입니다.

> **AI에게 통째로 맡기고 싶다면**
> 두 편을 한 번에 처리하는 프롬프트가 [1편 맨 위](/guide/vercel-domain-setup)에 있어요. 아래는 직접 손으로 하는 방법이에요.
