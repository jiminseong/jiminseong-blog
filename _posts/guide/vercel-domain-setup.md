...
> **직접 클릭하기 귀찮으신가요?**
> 컴퓨터를 대신 써 주는 AI가 있다면 아래 문장 하나로 이 글 전체를 맡길 수 있어요. Aside 브라우저, ChatGPT의 에이전트 기능, Claude의 컴퓨터 사용 기능 어디에 넣어도 됩니다. 대괄호 두 곳만 바꾸세요.
...
> 돈이 나가거나 되돌리기 어려운 곳에서는 사람이 직접 하도록 멈추게 되어 있어요. 이런 도구가 처음이라면 [Aside 브라우저 가이드](/guide/aside-browser-setup)와 [GPT-6 Astra 설명글](/guide/gpt-6-astra)을 먼저 읽어 보세요. 아래는 직접 손으로 하는 방법입니다.
